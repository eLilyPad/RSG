...
public abstract partial class NonogramDisplay : Container
{
	...
	public ColorRect BackgroundRect => field ??= Init(value: new ColorRect()
	{
		Name = "Background"
	});
	public Control Spacer => field ??= Init<Control>();
	public GridContainer Main => field ??= Init<GridContainer>();
