...
public sealed partial class Nonogram<T> : Container where T : IHavePenMode, IHaveColourPack
{
	...
	public Container Tiles => field ??= new TilesContainer(Data);
	...
	private sealed partial class TilesContainer : Container
	{
		private static Vector2I GridSize => Vector2I.One * 5;
		private static Vector2I GridSizeScaled => Vector2I.One * GridSize * 40;
