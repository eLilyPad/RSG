...
public abstract partial class NonogramDisplay : Container
{
	...
	public required virtual IConfig Config
	{
		get; set
		{
	...
	public interface IData { Dictionary<Position, List<int>> Hints(); }
