...
public sealed partial class Core : Node, IHavePenMode, IHaveColourPack, TilesContainer.IHandleButtonPress
{
	...
	public void OnButtonPressed(Vector2I position, Button button)
	{
		...
		{
			PenMode.Block when button.Text is TilesContainer.EmptyText or TilesContainer.FillText => TilesContainer.BlockText,
			PenMode.Block => TilesContainer.EmptyText,
			PenMode.Fill when button.Text is TilesContainer.EmptyText => TilesContainer.BlockText,
			PenMode.Fill when button.Text is TilesContainer.FillText => TilesContainer.EmptyText,
			_ => button.Text
		};
	}
...
public partial class NonogramPuzzle : Resource
{
