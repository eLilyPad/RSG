...
public partial class Nonogram : Node
{
	...
	public sealed record PuzzleData : NonogramHint.IData
	{
		...
		public Dictionary<NonogramDisplay.Position, List<int>> Hints()
		{
			Dictionary<NonogramDisplay.Position, List<int>> hints = [];
			foreach ((Vector2I position, bool check) in _checkedTiles)
			{
				NonogramDisplay.Position rowPos = new(NonogramDisplay.Side.Row, position.X),
