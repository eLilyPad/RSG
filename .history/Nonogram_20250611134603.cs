...
public partial class Nonogram : Node, IHavePenMode
{
	...
	public GameContainer GameDisplay => field ??= new(nonogram: this) { TilesLength = Settings.Length };
	public GameContainer PainterDisplay => field ??= new(nonogram: this) { TilesLength = Settings.Length };
	...
	public sealed partial class GameContainer(Nonogram nonogram) : NonogramDisplay
	{
		...
		internal void UpdateSettings(ColourPack colours, DisplayConfig config)
		{
