...
public partial class Nonogram : Node, IHavePenMode
{
	...
	{
		public override Control Spacer => field ??= new() { Name = "Spacer", Size = Tiles.Size };
		public override GridContainer Tiles => field ??= new() { Name = "Tiles", Columns = 2 };
