...
public abstract partial class NonogramDisplay : Container
{
	...
	public static T Init<T>(T value) where T : NonogramDisplay
	{
		value.InitBackGround(value.Background);
		value.InitTiles(value.Tiles);
		value.InitContainers(value.HintContainers);
		return value;
	}
	...
	public T Init<T>(T value) where T : NonogramDisplay
	{
