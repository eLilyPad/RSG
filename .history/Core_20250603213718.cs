...
public partial class Nonogram(ColourPack Colours) : Node, IHavePenMode, TilesContainer.IHandleButtonPress
{
	...
	{
		get => field ??= NonogramPainterContainer.Create(this, Colours, Settings);
		private set;
	}
