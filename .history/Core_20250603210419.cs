...
public partial class Nonogram(Core core) : Node, IHavePenMode, TilesContainer.IHandleButtonPress
{
	...
	public DisplaySettings Settings
	{
		...
		{
			field = value;
			GameDisplay.ReplaceAndRemove(replacement: NonogramContainer.Create(
				data: this,
				colours: core.Colours,
				displaySettings: field
			));
			PainterDisplay.ReplaceAndRemove(replacement: NonogramPainterContainer.Create(
				data: this,
				colours: core.Colours,
				displaySettings: field
			));
	...
	{
		get => field ??= NonogramContainer.Create(data: this, colours: core.Colours, displaySettings: Settings);
		private set;
	}
	public NonogramPainterContainer PainterDisplay
	{
		get => field ??= NonogramPainterContainer.Create(data: this, colours: core.Colours, displaySettings: Settings);
		private set;
	}
