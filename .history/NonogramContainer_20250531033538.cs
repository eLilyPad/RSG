...
public sealed partial class HintsContainer : BoxContainer
{
	...
	{
		get; init => (_hints, field) = (new[], value); }

	private readonly List<RichTextLabel>[] _hints = new List<RichTextLabel>[TilesContainer.GridLength];
...
public sealed partial class TilesContainer<T>(T data) : GridContainer where T : IHavePenMode, IHaveColourPack
{
	...
	public required Action<Vector2I> OnButtonPressed { get; init; }
