...
public abstract partial class NonogramDisplay : Container
{
	...
	public ColorRect Background { get; init => field = InitBackGround(value); } = new ColorRect
	{
		Color = Colors.White,
	...
	public (BoxContainer Rows, BoxContainer Columns) HintContainers
	{
		...
		{
			field = (
				InitHintContainer(new BoxContainer { Name = "RowHints" }),
				InitHintContainer(new BoxContainer { Name = "ColumnHints" })
			);
		}
	} = (
		new BoxContainer { Name = "RowHints" },
		new BoxContainer { Name = "ColumnHints" }
	);
