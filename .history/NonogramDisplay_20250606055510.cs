...
public abstract partial class NonogramDisplay : Container
{
	...
	public override void _Ready()
	{
		...
		Init(Background, HintContainers.Columns, HintContainers.Rows, Tiles);
	...
	private void Init(params Span<Control> values) { foreach (Control value in values) Init(value); }
