...
public partial class Nonogram : Node, IHavePenMode
{
	...
	public DisplaySettings Settings
	{
		get; set
		{
			...
			GameDisplay.Free();
			PainterDisplay.Free();
			this.Add(GameDisplay.Init(GameDisplay), PainterDisplay);

			T init<T>(T value) where T : NonogramDisplay
			{
				value.Init();
				return value;
			}
	...
	public sealed partial class GameContainer(Nonogram nonogram) : NonogramDisplay
	{
		...
		public override T Init<T>() where T : GameContainer
		{
			InitBackGround(Background);
			InitTiles(Tiles);
			InitContainers(HintContainers);
			return this;
		}
