...
public sealed partial class TilesContainer : GridContainer
{
	...
	public static TilesContainer Create<T>(
		IHandleButtonPress data,
		ColourPack colours,
		Nonogram.DisplaySettings displaySettings
	)
	where T : IHandleButtonPress
	{
		var tilesContainer = new TilesContainer(data.OnButtonPressed)
		{
			Name = "Tiles",
	...
	private TilesContainer(IHandleButtonPress onPressed)
	{
