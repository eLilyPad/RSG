...
{
	public static NonogramContainer GameDisplays(Nonogram nonogram)
	{
	...
	public static NonogramContainer PainterDisplay(Nonogram nonogram)
	{
		return new NonogramContainer
		{
			Background = ColouredBackground(nonogram.Colours, nonogram.Settings),
	...
	public static NonogramContainer Create(
		TilesContainer.IHandleTiles tilePressed,
		ColourPack colours,
