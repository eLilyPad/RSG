...
public abstract partial class ATilesContainer : GridContainer
{
	public const string BlockText = "X", FillText = "O", EmptyText = " ";
	public abstract Action<Vector2I, Button> OnButtonPressed { get; }
...
{
	public static TilesContainer Create(IHandleTiles TilePressedHandler, Nonogram.DisplaySettings displaySettings)
	{
	...
	public Dictionary<Vector2I, Button> Buttons { get; } = [];
	private TilesContainer(IHandleTiles TilePressed)
	{
	...
	public interface IHandleTiles
	{
		Button LastPressed { get; }

		void OnButtonPressed(Vector2I position, Button button);
		void OnButtonPressed(Vector2I position, Button button, Nonogram.PenMode mode)
		{
