...
public partial class Nonogram : Node, IHavePenMode
{
	...
	public sealed partial class GameContainer(Nonogram nonogram) : NonogramDisplay
	{
		...
		public override GridContainer Tiles => field ??= new GridContainer { Name = "Tiles" }
		.SizeFlags(horizontal: SizeFlags.ExpandFill, vertical: SizeFlags.ExpandFill)
		.AnchorsAndOffsetsPreset(preset: LayoutPreset.FullRect, resizeMode: LayoutPresetMode.KeepSize);
		public override ColorRect BackgroundRect => field ??= new ColorRect { Name = "Background" }
			.SizeFlags(
				horizontal: SizeFlags.ExpandFill,
				vertical: SizeFlags.ExpandFill
			)
		...
		public override void UpdateSettings<DisplayConfig>(DisplayConfig config)
		{
			BackgroundRect.Color = nonogram.Colours.NonogramBackground;
